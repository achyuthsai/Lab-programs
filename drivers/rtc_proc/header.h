...
#define		WRITE_SEC(a)	{ outb(SEC, CMD); \
				  outb(a, DATA);\
				}

#define		WRITE_MIN(a)	{ outb(MIN, CMD); \
				  outb(a, DATA);\
				}

#define		WRITE_HOU(a)	{ outb(HOU, CMD); \
				  outb(a, DATA);\
				}

#define		WRITE_DAY(a)	{ outb(DAY, CMD); \
				  outb(a, DATA);\
				}
...
#define		WRITE_MON(a)	{ outb(MON, CMD); \
				  outb(a, DATA);\
				}

#define		WRITE_YEA(a)	{ outb(YEA, CMD); \
				  outb(a, DATA);\
				}
